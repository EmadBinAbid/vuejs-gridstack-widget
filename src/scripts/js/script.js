...
$(window).on("load", function () {
      ...
      $("body").on("click", ".switch-full", function () {
            console.log("switch-full CLICKED");
            ...
            console.log('emad');
            let headerBtnParent = $(this).parents('.top-header-btns');
            console.log(this)
            let closeBtn = headerBtnParent[0].childNodes[9].childNodes[0]
            console.log(closeBtn);

            if (parent.hasClass('fullscreen')) {
                  $(closeBtn).find("i").attr('class', '')
                  $(closeBtn).attr('title', '')
                  $(closeBtn).css("pointer-events", "none")
            }
            else {
                  $(closeBtn).find("i").attr('class', 'icon dripicons-cross')
                  $(closeBtn).attr('title', 'Remove Panel')
